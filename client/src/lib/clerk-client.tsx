...
function getClerk() {
  if (!clerk) {
    ...
    // This is the test key you provided (pk_test_c3RhcnRsZWQtb3Bvc3N1bS0yMS5jbGVyay5hY2NvdW50cy5kZXYk)
    const publishableKey = 'pk_test_c3RhcnRsZWQtb3Bvc3N1bS0yMS5jbGVyay5hY2NvdW50cy5kZXYk';
