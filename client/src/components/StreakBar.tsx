...
export function StreakBar() {
  ...
  if (isLoading) {
    return (
      <div className="streak-bar-container bg-white p-2 rounded-md mb-4 animate-pulse border border-gray-200">
  ...
  return (
    <div 
      className="streak-bar-container bg-white p-2 px-3 rounded-md mb-4 shadow-sm transition-all hover:shadow-md border border-gray-200"
    >
